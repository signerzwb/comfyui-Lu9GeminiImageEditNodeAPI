...
class Lu9GimageUnified:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "output_mode": (["image_and_url", "url_only"], {"default": "image_and_url"}),
    ...
    def run(
        ...
        resolved_size_strategy = "preset_manual"
        ...
        try:
            ...
            if output_mode == "url_only":
                output_tensor = make_blank_image_tensor()
            else:
            ...
            response_payload = {
                ...
                "output_mode": output_mode,
                "response_format_requested": result.get("response_format_requested", "unknown"),
                "image_transport": result.get("image_transport", "unknown"),
                "seed": seed,
                "seed_mode": "comfyui_rerun_only",
            ...
            status_text = (
                ...
                f"transport={result.get('image_transport', 'unknown')} | "
                f"seed={seed} | "
            ...
            if skip_error:
                ...
                response_payload = {
                    ...
                    "output_mode": output_mode,
                    "response_format_requested": "url" if output_mode == "url_only" else "b64_json",
                    "image_transport": "failed_before_image_fetch",
                    "seed": seed,
                    "seed_mode": "comfyui_rerun_only",
                    "requested_aspect_ratio": aspect_ratio,
                    "resolved_aspect_ratio": resolved_aspect_ratio,
                ...
                status_text = (
                    ...
                    f"output_mode={output_mode} | "
                    f"transport=failed_before_image_fetch | "
                    f"seed={seed} | "
                    f"detail={str(exc)}"
                )
                return (
